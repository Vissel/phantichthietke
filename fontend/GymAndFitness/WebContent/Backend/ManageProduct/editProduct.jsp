	...
	<div class="row">
		...
		<div class="main-content-container container-fluid px-4"
			...
			<div class="col-sm-10" style="color: black;">
				<h1 style="margin-bottom: 50px; margin-top: 20px">Chỉnh sửa sản
					phẩm</h1>
				<%
					ProductThach product = dao.getOneProduct(Integer.parseInt(productID));
				%>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="form-group">
								<label class="mb-2 mr-sm-2">Mã sản phẩm:<span
									id="mandatory">*</span></label> <input type="text"
									class="form-control mb-2 mr-sm-2" name="codeProduct"
							...
							<div class="form-group">
								<label class="mb-2 mr-sm-2">Hình ảnh: </label> <input
									type='file' onchange="readURL(this);" name="img" /> <img
									id="blah" src="<%=product.getUrl()%>" />
							</div>
							<div class="form-group">
								<p style="margin-right: 130px">Mô tả:</p>
								<br>
								<textarea rows="6" cols="100" name="description"
									class="form-control" style="margin-top: 10px"><%=product.getDescription()%></textarea>
							</div>
						</div>
